# VIECULTURES - BỘ NỘI DUNG THUYẾT TRÌNH (CP1 - BẢN TIẾNG VIỆT)

_Nền tảng Học Tiếng Anh qua Bản sắc Văn hóa Việt Nam_

---

## Slide 1: Tiêu đề & Giới thiệu Đội ngũ
...
- **Ý chính**:
  ...
  - **Thành viên & Vai trò**:
    - `Trần Nguyễn Minh Bảo` – Kinh doanh Quốc tế (International Business)
    - `Ninh Thiện Luân` – Kỹ sư Phần mềm (Software Engineer)
    - `Nguyễn Phú Cường` – Kỹ sư Phần mềm (Software Engineer)
    - `Nguyễn Thị Thảo Tâm` – Marketing
    - `Phan Phục Trinh` – Marketing
    - `Nguyễn Trung Nam` – Marketing
...
- **Ý chính**:
  ...
  - **Tâm lý e ngại bị phán xét**: Áp lực bị sửa lỗi ngữ pháp và chấm điểm khiến người học ngần ngại viết và chia sẻ góc nhìn cá nhân.
...
- **Ý chính**:
  ...
  - **Flashcard Ngữ cảnh & Lặp ngắt quãng (Spaced Repetition)**: Thẻ nhớ 2 mặt bắt buộc đính kèm câu ngữ cảnh gốc, tự động xếp lịch ôn tập (1, 3, 7, 30 ngày).
  - **Cảm nghĩ Cộng đồng Không phán xét (Safe Reflections)**: Môi trường chia sẻ bài viết cảm nghĩ tự do, tuyệt đối không chấm điểm hay sửa lỗi ngữ pháp.
...
- **Ý chính**:
  ...
  - **Đột phá về Môi trường Học an toàn**: Tiên phong áp dụng chính sách 'Không phán xét' đối với bài viết cảm nghĩ của người học (UGC), xóa bỏ hoàn toàn e ngại khi viết.
  - **Tích hợp Công nghệ Hiện đại**: Giao diện cặp đoạn văn, âm thanh AI đọc từng câu và thuật toán lặp ngắt quãng SRS.
...
- **Ý chính**:
  - **Khách hàng Mục tiêu**:
    ...
    - Những người yêu văn hóa, du lịch muốn trở thành "Sứ giả Văn hóa" giới thiệu Việt Nam đến bạn bè quốc tế.
  - **Bối cảnh Thị trường**:
    - Thị trường EdTech Việt Nam tăng trưởng mạnh mẽ (>15% CAGR), nhu cầu học tiếng Anh ứng dụng cao.
    - Các ứng dụng hiện hữu (Duolingo, Elsa, báo tiếng Anh) thiếu độ sâu văn hóa bản địa và thiếu không gian thực hành viết an toàn.
...
- **Ý chính**:
  - **Luồng Trải nghiệm 5 bước**:
    ...
    2. **Đọc & Luyện âm (Read & Shadow)**: Đọc cặp đoạn song ngữ và nghe âm thanh AI từng câu.
    3. **Trích xuất Từ vựng (Vocab Extract)**: Bấm vào từ vựng được highlight để xem phiên âm IPA, nghĩa và câu ngữ cảnh gốc.
    4. **Ôn Flashcard (Flashcard Review)**: Ôn tập chủ động 2 mặt với đánh giá nhị phân ("Đã nhớ" / "Cần ôn lại").
    5. **Cảm nghĩ (Reflect)**: Viết cảm nghĩ lên dòng thời gian cộng đồng với thanh công cụ chèn nhanh từ vừa học.
  - **Các bên Liên quan (Stakeholders)**: Người học, Biên tập viên nội dung, Đối tác Du lịch & Văn hóa.
  - **Lời thoại thuyết trình (Speaker Notes)**: _"Luồng trải nghiệm chuyển tiếp mượt mà từ đọc thụ động sang ghi nhớ chủ động và cuối cùng là sáng tạo cá nhân trên cộng đồng."_
...
- **Ý chính**:
  ...
  - **Gói Đăng ký Cao cấp (Future Premium)**:
    - Đọc bài offline & tải xuống âm thanh.
    - Phản hồi phát âm AI nâng cao và bộ Flashcard không giới hạn.
...
- **Ý chính**:
  ...
  - **Gamification & Tính năng Xã hội**: Chuỗi ngày học (Streaks), điểm kinh nghiệm (EXP) và huy hiệu văn hóa.
...
- **Ý chính**:
  ...
  - **Phân công Trách nhiệm Nhóm**:
    - **Quản lý Sản phẩm & Kinh doanh (International Business)**: Định hướng tầm nhìn, nghiên cứu thị trường, quản lý scope.
    - **Phát triển Kỹ thuật (Software Engineers)**: Xây dựng giao diện UI/UX, hạ tầng Backend, tích hợp AI & thuật toán SRS.
    - **Nội dung & Marketing (Marketing Team)**: Biên soạn nội dung song ngữ, chiến lược tăng trưởng & truyền thông thương hiệu.
...
- **Ý chính**:
  ...
  - **Giai đoạn 3 (Thử nghiệm Beta)**: Khởi tạo 50 chủ đề bài học văn hóa, chạy thử nghiệm closed beta với 200+ sinh viên đại học.
  - **Giai đoạn 4 (Tối ưu & Mở rộng)**: Hoàn thiện dựa trên phản hồi người dùng và tích hợp Affiliate Marketing.
...
- **Ý chính**:
  ...
  - **Trân trọng cảm ơn! Nhóm xin nhận các câu hỏi và góp ý.**
